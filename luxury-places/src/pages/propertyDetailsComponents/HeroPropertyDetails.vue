...
<style scoped lang="scss">
    ...
    .backgroundPhoto {
        ...
        height: auto;
        position: absolute;
        -webkit-mask-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0)), color-stop(0.3, rgba(0, 0, 0, 1)), color-stop(0.7, rgba(0, 0, 0, 0.5)), to(rgba(0, 0, 0, 0)) );
    }
    .contentGrid {
        display: grid;
